...
FnVoid_VoidP_BleatGattCharP_UbyteC_Ubyte_CharP = CFUNCTYPE(None, c_void_p, POINTER(GattCharr), POINTER(c_ubyte), c_ubyte, c_char_p)
FnVoid_VoidP_BleatGattCharP_UbyteC_Ubyte = CFUNCTYPE(None, c_void_p, POINTER(GattCharr), POINTER(c_ubyte), c_ubyte)
